...
// --- NEW: State variable for shop balance ---

  var shopBalance = 0.0.obs;
...
// --- NEW: Fetch all data in parallel, including the shop balance ---
...
// --- NEW: Process the shop balance result ---

      final shopBalanceData = results[10] as Map;

      shopBalance.value = (shopBalanceData['balance'] as num? ?? 0.0).toDouble();
...
// --- NEW: StatCard for Shop Balance ---

        Obx(() => _StatCard(

          icon: Icons.account_balance_wallet_outlined,

          label: 'Current Shop Balance',

          value: currencyFormatter.format(controller.shopBalance.value),
